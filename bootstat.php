...
while($row = mysql_fetch_array($sql)){ 
	...
	///////  Mechanism to Display Book Pic. See if they have uploaded a pic or not  //////////////////////////
	$check_picb = "books/$id/$id.jpg";
	$default_picb = "books/0/image01.png";
	if (file_exists($check_picb)) {
    $user_picb = "<img src=\"$check_pic?$cacheBuster\" width=\"160px\" />"; 
	} else {
	$user_picb = "<img src=\"$default_pic\" width=\"160px\" />"; 
	}
...
<div class="container">
    <div class="right">
      <div id="mainContentR" class="tabs-content">
        ...
        <div class="text2">
          <table width="60%" height="160" border="0">
            <tr>
              <td colspan="2" rowspan="6"><?php echo $user_picb; ?>&nbsp;</td>
              <td>Boosdfk Name</td>
            </tr>
            <tr>
              <td></td>
