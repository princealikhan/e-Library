      ...
      <div id="mainContentR" class="tabs-content">
        ...
        <div class="text2">
          ...
          <table width="100%" border="1" cellpadding="0" cellspacing="0">
            <tr bgcolor="#00CC33">
              <td width="9%" class="text2"><center>Booking ID</center></td>
              <td width="41%" class="text2"><center>Date of Booking</center></td>
			...
			$sql=mysql_query("SELECT * FROM booking WHERE u_id='$id'");
while($row=mysql_fetch_array($sql)){
	$bid=$row['b_id'];
...
$date=$row['d_booking'];
 ...
 echo '<td><center>'.$bk_id.'</center></td>';
